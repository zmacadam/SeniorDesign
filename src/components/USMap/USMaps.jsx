            ...
            <div className={styles.container}>
                <Grid container spacing={1}>
                    <Grid item xs={3}>
                        ...
                        {check2 ?
                            <Chart nbdate={date} country="US" cond={cond} width={"600px"} height={"200px"}/> : null}
                    </Grid>
                    <Grid item xs={6}>
                    ...
                    <Grid item xs={3}>
                        {check2 ? <Infos nbdate={date}/> : null}
                    </Grid>
                </Grid>
                < br/>
                {!check1 ?
                    <div className={styles.maps}>
                        <Chart nbdate={date} country="US" cond={cond} width={"600px"} height={"200px"}/>
                        {/* <p>Abc</p> */}
                    </div> : null}
